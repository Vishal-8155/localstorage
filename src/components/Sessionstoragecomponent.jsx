...
function Sessionstoragecomponent() {
    ...
    const [alluserdata, setUserdata] = useState(() => {
        const storedData = JSON.parse(sessionStorage.getItem('EmpInfo'));
        return storedData || [];
    });
    ...
    const submitData = (e) => {
        ...
        sessionStorage.setItem("EmpInfo", JSON.stringify(updatedData));
    ...
    const empdata = JSON.parse(sessionStorage.getItem("EmpInfo"));
    const setData = (e) => {
    ...
    const deleteinfo = (id) => {
        let updatedData = JSON.parse(sessionStorage.getItem('EmpInfo'));
